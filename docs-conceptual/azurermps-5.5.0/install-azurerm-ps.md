...
Si desea usar Azure PowerShell en macOS o Linux, consulte el artículo siguiente:  
[Instalación y configuración de Azure PowerShell en macOS y Linux](install-azurermps-maclinux.md).
...
```
Además, quizás desee actualizar PowerShellGet con el siguiente comando:
```powershell
...
|Escenario|Instrucciones de instalación|
|---|---|
|Windows 10<br/>Windows Server 2016|Integrado en Windows Management Framework (WMF) 5.0 incluido en el sistema operativo|
|Quiero actualizar a PowerShell 5|<ol><li>[Instalar la versión más reciente de WMF](https://www.microsoft.com/en-us/download/details.aspx?id=54616)</li><li>Ejecute el siguiente comando:<br/>```Install-Module PowerShellGet -Force```</li></ol>|
|Uso una versión de Windows con PowerShell 3 o PowerShell 4|<ol><il>[Obtención de los módulos de administración de paquetes](http://go.microsoft.com/fwlink/?LinkID=746217)</il><li>Ejecute el siguiente comando:<br/>```Install-Module PowerShellGet -Force```</li></ol>|
